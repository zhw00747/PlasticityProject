...
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
     ...
     .                                 + C12*STRAININC(i,1)
            STRESS(3) = 0.0
            STRESS(4) = STRESSOLD(i,4) + C44*2.0*STRAININC(i,4)
         ! print*,"sold",stressold(i,1),stressold(i,2),stressold(i,3),
         !< stressold(i,4)
         ! print*,"de",strainInc(i,1),strainInc(i,2),strainInc(i,3),
         !<  strainInc(i,4)
         ! print*,"tr",stress
      !stop
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
       ! CHECK YIELD FUNCTION
!-----------------------------------------------------------------------
            !print*,"trial stress", stress
            !print*,"strainInc",strainInc(i,1),strainInc(i,2),
            !< strainInc(i,3),strainInc(i,4)
            F = PHI - SIGMAY
            DLAMBDA = 0.0
            IF(F.GT.0.0)THEN
               !print*,"first plastic inc AUNE"
               !print*,"trAUNE",stress
               !print*,"phi",phi
               !print*,"sigmaY",sigmay
               !stop
...
!-----------------------------------------------------------------------          
     ...
     .                          + QR3*(1-EXP(-CR3*P))
                F = PHI - SIGMAY
                RESNOR = ABS(F/SIGMAY)
                  !print*,"resnor",resnor,"iter",iter
                 IF(RESNOR.LE.TOL)THEN
                   !IF(ITER.GT.1)THEN
                     !print*,"shell converged in iter",iter
                     !stop
                     STRESSNEW(i,1) = STRESS(1) 
                     STRESSNEW(i,2) = STRESS(2)
                     STRESSNEW(i,3) = STRESS(3)
...
!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
  ...
  80         CONTINUE
         !print*,"----e33 corr:"
         !print*,"sigma11",stressnew(i,1)
         !print*,"sigma22",stressnew(i,2)
         !print*,"sold11",stressold(i,1)
         !print*,"sold22",stressold(i,2)
         !print*,"de11",strainInc(i,1)
         !print*,"de22",strainInc(i,2)
